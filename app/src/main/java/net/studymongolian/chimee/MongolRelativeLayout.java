...
public class MongolRelativeLayout extends RelativeLayout {
    ...
    public MongolRelativeLayout(Context context) {
        this(context, null);
    }

    public MongolRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
